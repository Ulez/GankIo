 ...
 */
public class GirlListActivity extends ToolbarActivity implements SwipeRefreshInf {
    ...
    private String TAG = "GirlListActivity";
    ...
    private void startPicturAcitivity(MyImageView imageView, Girl girl) {
        ...
        ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(GirlListActivity.this, imageView, PictureActivity.TRANSIT_IMG);
        try {
            ActivityCompat.startActivity(GirlListActivity.this, intent, optionsCompat.toBundle());
        } catch (Exception e) {
